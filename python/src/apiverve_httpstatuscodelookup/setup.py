...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/httpstatuslookup',
        'Source': 'https://github.com/apiverve/httpstatuslookup-api',
        'Bug Tracker': 'https://github.com/apiverve/httpstatuslookup-api/issues'
    },
    classifiers=[
