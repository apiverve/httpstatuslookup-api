...
class httpstatuslookupWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/httpstatuslookup');
        }
        ...
        this.validationRules = {"code":{"type":"integer","required":true,"min":100,"max":599}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/httpstatuslookup`);
        }
    }
...
module.exports = httpstatuslookupWrapper;
