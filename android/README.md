# HTTP Status Code Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:httpstatuslookup-api:1.1.13'
}
```
...
```java
import com.apiverve.httpstatuslookup.HTTPStatusCodeLookupAPIClient;
import com.apiverve.httpstatuslookup.APIResponse;
import com.apiverve.httpstatuslookup.APIException;

// Initialize the client
HTTPStatusCodeLookupAPIClient client = new HTTPStatusCodeLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("code", 404);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/httpstatuslookup](https://docs.apiverve.com/ref/httpstatuslookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/httpstatuslookup](https://docs.apiverve.com/ref/httpstatuslookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/httpstatuslookup-api/issues)
