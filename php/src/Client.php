...
namespace APIVerve\Httpstatuslookup;
...
/**
 * Client for the HTTP Status Code Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/httpstatuslookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/httpstatuslookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HttpstatuslookupClient] {$message}\n";
        }
    }
}
