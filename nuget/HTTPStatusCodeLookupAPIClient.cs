...
namespace APIVerve.API.HTTPStatusCodeLookup
{
    ...
    /// <summary>
    /// Client for the HTTPStatusCodeLookup API
    /// </summary>
    public class HTTPStatusCodeLookupAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/httpstatuslookup";
        ...
        {
            { "code", new ValidationRule { Type = "integer", Required = true, Min = 100, Max = 599 } }
        };
        ...
        public HTTPStatusCodeLookupAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTTPStatusCodeLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTTPStatusCodeLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HTTPStatusCodeLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(HTTPStatusCodeLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(HTTPStatusCodeLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(HTTPStatusCodeLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HTTPStatusCodeLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HTTPStatusCodeLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HTTPStatusCodeLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HTTPStatusCodeLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(HTTPStatusCodeLookupQueryOptions options)
        {
