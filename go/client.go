// Package httpstatuslookup provides a Go client for the HTTP Status Code Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/httpstatuslookup?utm_source=go&utm_medium=readme
package httpstatuslookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/httpstatuslookup"
	defaultTimeout = 30 * time.Second
)

// Client is the HTTP Status Code Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new HTTP Status Code Lookup API client.
...
// Execute makes a request to the HTTP Status Code Lookup API with typed parameters.
//
...
//   - code (required): integer - HTTP status code to lookup [min: 100, max: 599]
