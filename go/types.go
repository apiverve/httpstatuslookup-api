...
// Request contains the parameters for the HTTP Status Code Lookup API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"code": {Type: "integer", Required: true, Min: float64Ptr(100), Max: float64Ptr(599)},
	}
...
// ResponseData contains the data returned by the HTTP Status Code Lookup API.
